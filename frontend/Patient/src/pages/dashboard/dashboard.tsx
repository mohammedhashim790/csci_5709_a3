...
export default function PatientDashboard() {
  ...
  const handleJoin = () => {
    ...
    navigate("/meeting", {
      state: {
        meetingId: upcomingAppointment.meetingId._id,
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        const now = new Date();
        const futureAppointments = (data.appointments as RawAppointment[]).filter(
    ...
    <div className="p-4 md:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6">
        ...
        <div className="card flex flex-col justify-between">
          ...
          <Button className="carebridge-primary-btn cursor-pointer w-full text-white font-semibold py-2 rounded-md">
            Pay
          </Button>
        </div>
        ...
        {upcomingAppointment && (
          <div className="card">
            ...
            <div className="flex gap-2">
              <Button onClick={handleJoin} className="carebridge-primary-btn cursor-pointer flex-1 text-white font-semibold py-2 rounded-md">
                Join
              </Button>
              <Button
                variant="outline"
